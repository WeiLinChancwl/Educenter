          ...
          <div class="col-lg-7">
            <div class="p-5">
              <div class="text-center">
                <h1 class="h4 text-gray-900 mb-4">注册</h1>
              </div>
              <form class="user">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="newaccount" name="newaccount" placeholder="账号">
                  </div>
                </div>
                ...
                <a href="superuserlogin.ftl" class="btn btn-primary btn-user btn-block">
                  Register Account
                </a>
                <hr>
                <a href="superuserindex.ftl" class="btn btn-google btn-user btn-block">
                  <i class="fab fa-google fa-fw"></i> Register with Google
                </a>
                <a href="superuserindex.ftl" class="btn btn-facebook btn-user btn-block">
                  <i class="fab fa-facebook-f fa-fw"></i> Register with Facebook
                </a>
              </form>
              <hr>
              <div class="text-center">
                <a class="small" href="forgot_password.ftl">Forgot Password?</a>
              </div>
              <div class="text-center">
                <a class="small" href="superuserlogin.ftl">Already have an account? Login!</a>
              </div>
            </div>
          </div>
        </div>
