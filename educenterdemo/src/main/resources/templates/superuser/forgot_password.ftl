              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <p class="mb-4">只需在下面输入您的电子邮件地址，我们将向您发送一个链接来重置您的密码！</p>
                  </div>
                  <form class="user">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="输入Email...">
                    </div>
                    <a href="/superuserlogin" class="btn btn-primary btn-user btn-block">
                      重置密码
                    </a>
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="/superuserregister">创建账户</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="/superuserlogin">已有账号？登录！</a>
                  </div>
                </div>
              </div>
            </div>
