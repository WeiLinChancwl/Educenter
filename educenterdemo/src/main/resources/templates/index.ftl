                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h1 class="text-white" data-animation-out="fadeOutRight" data-delay-out="5"
                                ...
                                data-delay-in=".1">${slide.slideTitle}</h1>
                            ...
                            <a href="/contact" class="btn btn-primary" data-animation-out="fadeOutRight"
                               data-delay-out="5"
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center section-title justify-content-between">
                    ...
                    <div>
                        <a href="/courses" class="btn btn-sm btn-primary-outline ml-sm-3 d-none d-sm-block">查看全部</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-5">
                    <div class="card p-0 border-primary rounded-0 hover-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/course-single?courseId=${course.cId}">
                                <h4 class="card-title">${course.cName}</h4>
                            </a>
                            <p class="card-text mb-4">${course.cDesc}</p>
                            <a href="/course-single?courseId=${course.cId}" class="btn btn-primary btn-sm">现在申请</a>
                        </div>
                    </div>
                </div>
            </#list>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="/courses" class="btn btn-sm btn-primary-outline d-sm-none d-inline-block">查看全部</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <a href="/contact" class="btn btn-secondary">现在加入</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-4 position-relative success-video">
                <a class="play-btn venobox" href="https://www.bilibili.com/bangumi/play/ep310999?spm_id_from=333.851.b_62696c695f7265706f72745f67756f636875616e67.42" data-vbtype="video">
...
<section class="section bg-gray">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="d-flex align-items-center section-title justify-content-between">
                    ...
                    <div class="border-top w-100 border-primary d-none d-sm-block"></div>
                    <div>
                        <a href="events" class="btn btn-sm btn-primary-outline ml-sm-3 d-none d-sm-block">查看全部</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                    <div class="card border-0 rounded-0 hover-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <a href="event-single?eventId=${event.eventId}"><h4
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="/events" class="btn btn-sm btn-primary-outline d-sm-none d-inline-block">查看全部</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container">
        <div class="d-flex align-items-center section-title justify-content-between">
            ...
            <div class="border-top w-100 border-primary d-none d-sm-block"></div>
            <div>
                <a href="/teacher" class="btn btn-sm btn-primary-outline ml-sm-3 d-none d-sm-block">查看全部</a>
            </div>
        </div>
        <div class="row justify-content-center">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="/teacher" class="btn btn-sm btn-primary-outline d-sm-none d-inline-block">查看全部</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section pt-0">
    <div class="container">
        <div class="d-flex align-items-center section-title justify-content-between">
            <h2 class="mb-0 text-nowrap mr-3">最新的博客文章</h2>
            <div class="border-top w-100 border-primary d-none d-sm-block"></div>
            <div>
                <a href="/blog" class="btn btn-sm btn-primary-outline ml-sm-3 d-none d-sm-block">查看全部</a>
            </div>
        </div>
        <div class="row justify-content-center">
            <#list blogs as blog>
                ...
                <article class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                    <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <a href="blog-single?blogId=${blog.blogId}" class="btn btn-primary btn-sm">查看更多</a>
                        </div>
                    </div>
                </article>
            </#list>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="/blog" class="btn btn-sm btn-primary-outline d-sm-none d-inline-block">查看全部</a>
            </div>
        </div>
    </div>
</section>
