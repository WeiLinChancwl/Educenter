    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">能力档案</a></li>
          ...
          <div class="card p-0 border-primary rounded-0 hover-shadow">
            <div class="card-body">
              <ul class="list-inline mb-2">
                <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>${stucourse.cName}
                </li>
                <li class="list-inline-item">${stucourse.status}</a></li>
              </ul>
              <a href="/course-single?courseId=${stucourse.cId}">
      ...
      <#list stutrains as stutrain>
        ...
        <div class="col-lg-4 col-sm-6 mb-5">
          <div class="card p-0 border-primary rounded-0 hover-shadow">
            <div class="card-body">
              <ul class="list-inline mb-2">
                <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>${stutrain.trainName}
                </li>
                <li class="list-inline-item">${stutrain.status}</a></li>
              </ul>
              <a href="/student-train-single?trainId=${stutrain.trainId}">
