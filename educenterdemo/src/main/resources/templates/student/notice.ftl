    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="@@page-link">通知</a></li>
      ...
      <div class="col-12">
        <ul class="list-unstyled">
          ...
          <li class="d-md-table mb-4 w-100 border-bottom hover-shadow">
            <div class="d-md-table-cell text-center p-4 bg-primary text-white mb-4 mb-md-0"><span class="h2 d-block">${notice.noticeTime}</span>${notice.noticeDate}</div>
            <div class="d-md-table-cell px-4 vertical-align-middle mb-4 mb-md-0">
              <a href="student-notice-single?noticeId=${notice.noticeId}" class="h4 mb-3 d-block">${notice.title}</a>
              <p class="mb-0">${notice.content}</p>
            </div>
            <div class="d-md-table-cell text-right pr-0 pr-md-4"><a href="student-notice-single?noticeId=${notice.noticeId}" class="btn btn-primary">查看更多</a></div>
          </li>
          </#list>
        </ul>
      </div>
