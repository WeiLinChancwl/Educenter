                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <a href="/contact" class="btn btn-primary" data-animation-out="fadeOutRight"
                               data-delay-out="5"
                               data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".7">现在申请</a>
                        </div>
                    </div>
                </div>
            </#list>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 order-2 order-md-1">
                ...
                <p>教育中心</p>
                <a href="student-about" class="btn btn-primary-outline">了解更多</a>
            </div>
    ...
    <div class="container">
                ...
                <div class="d-flex align-items-center section-title justify-content-between">
                    ...
                    <div>
                        <a href="/student-course"
                           class="btn btn-sm btn-primary-outline ml-sm-3 d-none d-sm-block">查看全部</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card p-0 border-primary rounded-0 hover-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/student-course-single?courseId=${course.cId}"
                               class="btn btn-primary btn-sm">现在申请</a>
                        </div>
                    </div>
                </div>
            </#list>
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="/student-courses" class="btn btn-sm btn-primary-outline d-sm-none d-inline-block">查看全部</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                ...
                <a href="/student-contact" class="btn btn-secondary">现在加入</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section bg-gray">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a href="/student-events" class="btn btn-sm btn-primary-outline d-sm-none d-inline-block">查看全部</a>
            </div>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <h2 class="section-title">我们的老师</h2>
            </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                    <div class="card border-0 rounded-0 hover-shadow">
                        <img class="card-img-top rounded-0" src="assetEducenter/images/teachers/${teacher.tImg}"
                             alt="teacher">
                        <div class="card-body">
                            <a href="student-teacher-single?teacherId=${teacher.tId}">
