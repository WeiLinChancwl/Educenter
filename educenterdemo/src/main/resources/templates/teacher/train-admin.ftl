        ...
        <div class="row">
            <div class="col-md-8">
                <ul class="list-inline custom-breadcrumb">
                    <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="/teacher-train">综合实训管理</a></li>
    ...
    <div data-ref="mixitup-target" class="container">
        <div class="row">
            <div class="col-12">
                <ul class="list-inline text-center filter-controls mb-5">
                    <li class="list-inline-item m-3 text-uppercase" data-filter=".news">实训动态</li>
                    <li class="list-inline-item m-3 text-uppercase" data-filter=".alerts">实训公告</li>
                    <li class="list-inline-item m-3 text-uppercase" data-filter=".resources">实训资源</li>
                    <li class="list-inline-item m-3 text-uppercase" data-filter=".homework">实训任务</li>
        ...
        <div class="row" data-ref="mixitup-container">
            ...
            <div data-ref="mixitup-target" class="mb-5 alerts">
                <div class="border-0 rounded-0 hover-shadow">
                    <div class="row justify-content-center">
                        <form action="/addTrainDesc?trainId=${train.trainId}" method="POST" enctype="multipart/form-data">
            ...
            <div data-ref="mixitup-target" class="mb-5 resources">
                <div class="border-0 rounded-0 hover-shadow">
                    <div class="row justify-content-center">
                        ...
                        <br/><br/><hr/>
                        <form action="/uploadTrain?trainId=${train.trainId}" method="POST" enctype="multipart/form-data">
            ...
            <div data-ref="mixitup-target" class="mb-5 homework">
                <div class="border-0 rounded-0 hover-shadow">
                    <div class="row justify-content-center">
                        <form action="/addhomework?trainId=${train.trainId}" method="POST" enctype="multipart/form-data">
